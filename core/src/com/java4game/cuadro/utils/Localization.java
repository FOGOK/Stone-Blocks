...
public class Localization {
    ...
    private static String[] rusLetters = new String[]{
        "назад", "тренировка", "привет!!!\n меня зовут мувер", "BLOCK MOVER", "версия 0.0.1\n\n" +
            ...
            "время", "минута", "максимальное время!!!", "победа", ":с", "рестарт", "меню", "далее", "все время: ", "назад",
    ...
    public enum CffsKey{
        CTBCFT, TURBO, TR1, TR11, TR12, TR13, BRONZESILVERGOLD, WIN, LOSE
    }

    //RUS сffs
    private static float[] rusCffs = new float[]{
            0.7f, 0.5f, 0.7f, 0.6f, 0.8f, 0.7f, 0.9f, 0.6f, 1.2f
    };
    ///
