...
public class TypeGameButton extends BaseButton {
    ...
    public TypeGameButton(ButtonActions.All action, float x, float y, float h, int back, int type, boolean isTextBlockEnable) {
    ...
    private void refreshPositionSideInformation(){
        ...
        textBlock.setPositionToCenter(textBlock.getBounds().getWidth(), winSprite.getHeight() + textBlock.getBounds().getHeight() * 1.3f);
        textBlock2.setPosition(bounds.getX() + bounds.getWidth() / 2f + bounds.getWidth(), bounds.getY() + bounds.getHeight() / 2f);
        textBlock2.setPositionToCenter(textBlock2.getBounds().getWidth(), targSprite.getHeight() + textBlock2.getBounds().getHeight() * 1.3f);
